...
/**
 * @extends PersistentProxyObjectFactory<ListeningHistory>
 */
final class ListeningHistoryFactory extends PersistentProxyObjectFactory
{
    /**
    ...
    protected function defaults(): array|callable
    {
        return [
            ...
            'listenedAt' => \DateTimeImmutable::createFromMutable(self::faker()->dateTimeBetween('-6 months', 'now')),
